...
def run_integrity_attack():
    ...
    # 1. Mallory se conecta legitimamente (ela tem certificado válido)
    try:
    ...
    # 2. Iniciar Handshake DH falso com a Vítima
    ...
    # 3. Esperar a chave pública do Bob
    ...
    # Montamos o pacote corrompido: Conteúdo Falso + Assinatura da Original
    fake_packet = {
        "type": "MSG",
